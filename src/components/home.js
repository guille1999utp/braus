...
const Home = () => {
  ...
  return (
    ...
    <RiShoppingBagLine fontSize={90} className="iconHome"/>
      ...
      <p style={{fontSize:"18px",opacity:"0.8"}}>Este es tu porcentaje de descuento acumulado</p>
      <p style={{fontWeight:"600"}}>{User.porcentaje}%</p>
      <p style={{marginTop:"-7px",fontSize:"18px",opacity:"0.8"}}>Fecha ultima compra:<span>06/08/2022</span></p>
      <p style={{marginTop:"7px",fontSize:"18px",opacity:"0.8"}}>Dias de vigencia:<span>10</span></p>
